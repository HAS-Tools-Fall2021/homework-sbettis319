...
for i in range(len(year)):
        if flow[i] > 100 and year[i] <= 2000 and month[i] == 9:
                ilist3.append(i)
...
for i in range(len(year)):
        if flow[i] > 100 and year[i] >= 2010 and month[i] == 9:
                ilist4.append(i)
...
#ilist2 = [i for i in range(len(flow)) if flow[i] > 100 and month[i]== 9]
#print(len(ilist2))
